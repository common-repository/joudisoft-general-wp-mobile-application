        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dis-block width-100per text-center">
              <h3 class="mar-t-10 mar-b-20 text-bold">
                <i class="fa fa-check fw-rl10"></i>Application Has Been Created
              </h3>
              <div class="alert alert-success box-rounded">
                <p class="lead line-height-2em">Well done! your appliction has been successfully created
                  <br>Please keep the below transfer key safe you may asked for it later
                </p>
                <div class="transfer-key-view-welcome">
